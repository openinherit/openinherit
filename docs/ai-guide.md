...
INHERIT is an open estate data interchange standard for structured estate planning information. It defines 22 core entity schemas, 9 common types (money, address, jurisdiction, temporal-rule, identifier, visibility, media, completeness, tax-position), and 13 jurisdiction/cultural extensions — enabling estate planning data to move between software systems, legal professionals, and AI tools across 7 legal traditions (common law, civil law, mixed, religious, customary, socialist, and hybrid).
