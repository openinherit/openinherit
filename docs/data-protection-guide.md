...
| **Extension choice** | Which extension is active | **Religious belief** (by inference) | Choosing the `islamic` or `jewish` extension implies religious affiliation | The extension choice should be framed as "Which succession law applies?" NOT "What is your religion?" The legal system determines the extension, not personal faith. A non-Muslim in the UAE may still need the Islamic extension because Shariah applies to their estate. |
